...
function YouTubeApi() {
  ...
  useEffect(()=>{
      fetch('https://www.googleapis.com/youtube/v3/search?key=AIzaSyCjZ-9-Buml44ls98csL-d3vDN5IhaKc0A&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=9')
